...
public class DetCov_GUI extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        Lbl_Question.setText("PERTANYAAN AKAN MUNCUL DI SINI !!!");
        ...
        jButton_Next_Q.setBackground(new java.awt.Color(102, 102, 255));
    ...
    private void jButton_Next_QActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_Next_QActionPerformed
        ...
        if(jButton_Next_Q.getText().equals("Ulangi Sesi Test Covid-19"))
        {
        ...
        if(index == questions.length)
        {
            ...
            jButton_Next_Q.setText("Ulangi Sesi Test Covid-19");
        }
             ...
             if(index == questions.length-1){
                 jButton_Next_Q.setText("Test Selesai & Lihat Hasilnya");
             }
